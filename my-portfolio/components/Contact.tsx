  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <M.div initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-6 rounded-2xl glass">
        <p className="text-slate-700">Email: <a className="underline" href="mailto:jared@jaredberesford.com">jared@jaredberesford.com</a></p>
        <p className="text-slate-700 mt-2">Or reach out on LinkedIn / Twitter — links coming soon.</p>
        <div className="mt-4">
          <a href="mailto:jared@jaredberesford.com" className="inline-block px-4 py-2 bg-amber-500 text-slate-900 rounded-lg">Shoot an email</a>
        </div>
      </M.div>
    </div>
  );
