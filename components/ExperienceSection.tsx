...
const stints: Stint[] = [
  {
    ...
    category: 'Internship',
    impact:
      'Built full-stack inventory software (React · Supabase · Azure) with real-time sync and low-stock alerts across 500+ SKUs; CI/CD cut releases from 24h to under 30 min.',
    serial: '№ 0025',
    rotate: -1.2,
  },
  {
    ...
    category: 'Leadership',
    impact:
      'Directed PROGSU’s first hackathon to 400+ attendees and $20K+ in sponsorships, leading a 20-person exec team on a 5-week timeline.',
    serial: '№ 0042',
    rotate: 0.9,
  },
  {
    ...
    category: 'Internship',
    impact:
      'Mobile-first React refactor — 40% faster page loads, ~25% smaller bundle, and +15% traffic via SEO.',
    serial: '№ 0024',
    rotate: -0.8,
  },
];
